...
### Back-End
- GET /api/github/user/{username}: Retorna os dados do perfil de um usuário do GitHub.
- GET /api/github/followings/{username}: Retorna a lista de seguidos do usuário GitHub.
